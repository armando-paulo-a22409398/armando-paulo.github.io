...
// 1️⃣ Encontra o <section id="produtos">
const secaoProdutos = document.getElementById('produtos');

// 2️⃣ Percorre a lista de produtos
produtos.forEach(produto => {
  // 3️⃣ Cria um <article>
  const artigo = document.createElement('article');
  artigo.classList.add('produto');

  // 4️⃣ Adiciona o conteúdo do produto dentro do <article>
  artigo.innerHTML = `
  ...
  // 5️⃣ Junta o <article> dentro da <section>
